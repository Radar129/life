...
export function RadarAnimation() {
  return (
    ...
    >
      ...
      <div className="absolute inset-[25%] border border-primary/30 rounded-full"></div>
      <div className="absolute inset-[50%] border border-primary/30 rounded-full"></div>
      <div className="absolute inset-[75%] border border-primary/30 rounded-full"></div>

      {/* Optional: crosshair lines */}
      <div className="absolute w-full h-[1px] bg-primary/20 top-1/2 -translate-y-1/2"></div>
      <div className="absolute h-full w-[1px] bg-primary/20 left-1/2 -translate-x-1/2"></div>
      
      {/* Sweeping Line */}
      <div className="absolute w-full h-full animate-[spin_3s_linear_infinite]">
        {/* The arm of the radar */}
        <div 
          className="absolute top-1/2 left-1/2 w-1/2 h-[2px] bg-gradient-to-r from-primary/10 via-primary/80 to-primary "
          style={{ 
